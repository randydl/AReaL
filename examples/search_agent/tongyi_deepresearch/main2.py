...
client = SingleModelOpenAIClient(
    client=OpenAI(
        api_key="EMPTY",
        base_url="http://10.239.2.27:18002/v1",
    ),
    model="epoch2epochstep249globalstep749",
)
...
df.to_json('epoch2epochstep249globalstep749.jsonl', orient='records', force_ascii=False, lines=True)
